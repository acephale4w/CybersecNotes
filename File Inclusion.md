...
![[Pasted image 20240129204108.png]]

![[Pasted image 20240129204122.png]]


![[Pasted image 20240129204343.png]]


![[Pasted image 20240129204356.png]]


![[Pasted image 20240129204407.png]]![[Pasted image 20240129204421.png]]
...
This works because the PHP filter only matches and replaces the first subset string ../ it finds and doesn't do another pass, leaving what is pictured below.![[Pasted image 20240129210940.png]]
...
An external server must communicate with the application server for a successful RFI attack where the attacker hosts malicious files on their server. Then the malicious file is injected into the include function via HTTP requests, and the content of the malicious file executes on the vulnerable application server.![[Pasted image 20240129211000.png]]RFI steps
...
Visit the following lab URL: http://10.10.254.208/playground.php[](http://10.10.254.208//playground.php) to try out an RFI attack.As a developer, it's important to be aware of web application vulnerabilities, how to find them, and prevention methods. To prevent the file inclusion vulnerabilities, some common suggestions include:
